...
setPage((page) => page - 1)
  ...
  return (
    <div className={styles.pagination}>
        <button onClick={previousHandler} className={page === 1 ? styles.desiabled : null} >previous</button>
        ...
        <button onClick={nextHandler} className={page === 10 ? styles.desiabled : null } >next</button>
        </div>
  )
}
